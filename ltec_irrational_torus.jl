...
# Define parameters for the quasi-periodic system
omega1 = 1.0         # Base frequency
omega2 = sqrt(2)     # Irrational frequency for quasi-periodicity
...
z0 = 0.0             # Initial condition for z
...
# Euler Integration for the quasi-periodic system
for i in 1:num_steps
    # Compute derivatives based on the quasi-periodic system
    dx_dt = -omega1 * y + A * sin(z)
    dy_dt = omega1 * x + A * cos(z)
    dz_dt = omega2
...
selected_sv_index = 1  # Change this value between 1 and embedding_dim as needed
